  ...
  return (
    <section className="py-10 lg:py-16 w-full">
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <FadeIn>
          <div className="bg-[#7FD148] rounded-[1.5rem] py-6 px-6 lg:pl-10 lg:pr-6 flex flex-col lg:flex-row items-center justify-between gap-12 overflow-hidden relative w-full min-h-[440px]">
            <div className="relative z-10 w-full lg:w-1/2">
              <h2 className="text-[2rem] leading-[40px] lg:text-[2.5rem] lg:leading-[46px] font-bold tracking-[-0.02em] text-white mb-4">
                The Future of<br />Investing Starts Here
              </h2>
              ...
              <div className="flex flex-row items-center gap-4 w-full sm:w-auto">
                <button className="flex-1 sm:flex-none px-4 sm:px-8 py-3.5 rounded-full bg-[#91E45A] text-white text-[0.875rem] md:text-base font-medium hover:bg-[#85D650] transition-colors">
                  Download App
                </button>
            ...
            <div className="relative z-10 w-full lg:w-[45%] xl:w-[500px] flex justify-end h-full">
              <div className="w-full h-full min-h-[250px] lg:min-h-[400px] bg-white/20 rounded-[1rem] backdrop-blur-sm"></div>
            </div>
          </div>
        </FadeIn>
      </div>
