      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-[42px]">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
            ...
            <FadeIn delay={0.05}>
              <h1 className="text-[2.5rem] leading-[48px] sm:text-[2.75rem] sm:leading-[52px] lg:text-[3.5rem] lg:leading-[64px] font-bold tracking-[-0.03em] text-gray-900 mb-6 max-w-[320px] sm:max-w-[440px] lg:max-w-none">
                Designed for growth in every market cycle.
              </h1>
            </FadeIn>
