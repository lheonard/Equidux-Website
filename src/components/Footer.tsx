    ...
    <footer className="bg-[#0A0A0A] pt-20 pb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-[#aaaaaa]">
                ...
                <li>
                  <span className="block text-white mb-1">Abuja</span>
                  45 Capital Avenue,
                  <br />
        ...
        <FadeIn delay={0.2}>
          <div className="flex flex-col items-center justify-center gap-6 mb-8">
            ...
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-[#1A1A1A] flex items-center justify-center text-[#A3A3A3] hover:text-white hover:bg-gray-800 transition-all"
      ...
      <FadeIn delay={0.3}>
        <div className="w-full border-t border-[#1D1D1D]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-[42px] py-8 flex justify-center">
